...
_Kinematic_ settings are a more advanced topic and will be discussed in future tutorials ([1](./Contents.md#36-coupled-motion-and-resolving-targets),[2](./Contents.md#38-add-target-constraints),[3](./Contents.md#39-add-mechanism-constraints).
...
- [McNeel's Rhinoceros 3D and Grasshopper](https://www.rhino3d.com/download), and the HAL Robotics Framework installed on a PC.
- Reading or watching the [Synchronize Motion](./Contents.md#35-synchronize-motion) tutorial is highly recommended.
- Reading or watching the [Coupled Motion and Resolving Targets](./Contents.md#36-coupled-motion-and-resolving-targets) tutorial is highly recommended.
