...
<!-- tsGuideRenderComment {"guide":{"id":"eE3ikN0Ml","path":"HAL/Overview","fragmentFolderPath":"HAL/Overview/Glossary_frags"}} -->
...
these are similar to the options you have in your [controller](#controller). They are the actual software modules that implement different [capabilities](#capabilities). Details of different _subsytems_ can be found in the [manufacturer-specific documentation](../Manufacturers.md).
