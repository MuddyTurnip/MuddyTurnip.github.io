...
<!-- tsGuideRenderComment {"guide":{"id":"eE3j1N1ED","path":"HAL/Grasshopper","fragmentFolderPath":"HAL/Grasshopper/4-IO_frags"}} -->
...
- [McNeel's Rhinoceros 3D and Grasshopper](https://www.rhino3d.com/download), and the HAL Robotics Framework installed on a PC.
- Reading or watching the [Create a Signal](./4-IO.md#41-create-a-signal) tutorial is highly recommended and this tutorial builds on its output.
