...
<!-- tsGuideRenderComment {"guide":{"id":"eE3j841KJ","path":"HAL/Grasshopper","fragmentFolderPath":"HAL/Grasshopper/3-Motion_frags"}} -->
...
_Kinematic_ settings are a more advanced topic and will be discussed in future tutorials ([1](./3-Motion.md#36-coupled-motion-and-resolving-targets),[2](./3-Motion.md#38-add-target-constraints),[3](./3-Motion.md#39-add-mechanism-constraints).
...
- [McNeel's Rhinoceros 3D and Grasshopper](https://www.rhino3d.com/download), and the HAL Robotics Framework installed on a PC.
- Reading or watching the [Synchronize Motion](./3-Motion.md#35-synchronize-motion) tutorial is highly recommended.
- Reading or watching the [Coupled Motion and Resolving Targets](./3-Motion.md#36-coupled-motion-and-resolving-targets) tutorial is highly recommended.
...
[Continue to: 4. I/O](./4-IO.md#4-io)