...
<!-- tsGuideRenderComment {"guide":{"id":"eE3jVs0w1","path":"HAL/decode","fragmentFolderPath":"HAL/decode/3-Programming_frags"}} -->
...
- A [Robot](../Overview/Glossary.md#manipulator) in the **Scene**
- A [Controller](../Overview/Glossary.md#controller) in the **Scene**
- A [Signal](../Overview/Glossary.md#signal) in your **Network**. If you don't have one, see the [Create a Signal](./2-Cell.md#26-create-a-signal) tutorial for more information.
...
- A [Robot](../Overview/Glossary.md#manipulator) in the **Scene**
- A [Controller](../Overview/Glossary.md#controller) in the **Scene**
- A [CAD Model](./2-Cell.md#24-create-a-part) in the **Scene**
...
The other **Sources** allow you to create curves on any CAD Models you have imported. They will all ask you for one or more **Host** **Locations** which can be selected on any CAD Model in your **Scene**, and then a series of relevant **Settings**. There lots of possibilities here so it's well worth experimenting with all the options to see what can be achieved. For example from the **Spiral** _Source_, setting the _Inner Radius_ and _Outer Radius_ to the same value (maybe even a [Variable](./1-Getting-Started.md#14-variables)), and deactivating **Flat**, will allow you to create a cylindrical spiral at some point(s) on your CAD Model. Or linking your **Location(s)** to a [Variable](./1-Getting-Started.md#14-variables) will allow you to apply several different curves to the same locations.
...
[Continue to: 4. Operator Workflows](./4-Workflows.md#4-operator-workflows)